...
![Memory layout di un processo](./processes-vs-threads/Memory-layout-processo.png)
...
![Diagramma degli stati di un processo](./processes-vs-threads/Diagrammi-stati-processo.png)
...
![Code dei processi nei vari stati](./processes-vs-threads/Code-processi-in-stati.png)

![Transizioni tra code](./processes-vs-threads/Transizioni-tra-code.png)
...
![Schedulatore a breve termine con schedulatore a medio termine](./processes-vs-threads/Schedulatore-Breve-Termine-Schedulatore-Medio-Termine.png)
...
![Cambio di contesto](./processes-vs-threads/Context-switch.png)
...
![Albero dei processi](./processes-vs-threads/Albero-processi.png)
...
![Esecuzione dei processi](./processes-vs-threads/Process-execution-model.png)
...
![Threads vs Processes](./processes-vs-threads/Threads-vs-Processes.png)

Rappresentazione di un processo nella memoria centrale:

![Processo in memoria](./processes-vs-threads/Processo-in-memoria.png)

Rappresentazione di più thread nella memoria centrale:

![Thread in memoria](./processes-vs-threads/Thread-in-memoria.png)
...
![One to one thread mapping](./processes-vs-threads/One-to-One-ThreadMapping.png)
