...
<LinkButton href="https://github.com/malafronte/malafronte-doc-samples/tree/main/samples-quarta/EFCore/EFGetStarted" icon="github">
  Ottieni il codice
</LinkButton>
...
<Tabs>
  ...
  <TabItem label="Powershell" icon="laptop">
    ```ps1
  ...
  <TabItem label="Bash" icon="laptop">
    ```sh
    # per impostare il proxy a scuola
...
<RemoteCode 
  url="https://raw.githubusercontent.com/malafronte/malafronte-doc-samples/main/samples-quarta/EFCore/EFGetStarted/EFGetStarted/Model.cs"
  lang="csharp"
  title="Model.cs"
/>
...
![DB Browser Open Database](./getting-started/DB_Browser_Open_Database.png)

Si selezioni il file del database di SQLite e si osservi le tabelle create:

![Created Tables in DB Browser](./getting-started/Created_Tables_in_DB_Browser.png)
...
* **Inserire dati nel database**.  
  Per inserire dati nel database si modifichi il file `Program.cs` con il seguente codice:
    ...
    ![First value inserted in Blogs table](./getting-started/First_VAlue_inserted_in_Blogs_table.png)
...
<LinkButton href="https://github.com/malafronte/malafronte-doc-samples/tree/main/samples-quarta/EFCore/GestioneFattureClienti" icon="github">
  Ottieni il codice
</LinkButton>
...
<RemoteCode 
  url="https://raw.githubusercontent.com/malafronte/malafronte-doc-samples/main/samples-quarta/EFCore/GestioneFattureClienti/GestioneFattureClienti/Model/Cliente.cs"
  lang="csharp"
  title="Cliente.cs"
/>
...
<RemoteCode 
  url="https://raw.githubusercontent.com/malafronte/malafronte-doc-samples/main/samples-quarta/EFCore/GestioneFattureClienti/GestioneFattureClienti/Model/Fattura.cs"
  lang="csharp"
  title="Fattura.cs"
/>
...
<RemoteCode 
  url="https://raw.githubusercontent.com/malafronte/malafronte-doc-samples/main/samples-quarta/EFCore/GestioneFattureClienti/GestioneFattureClienti/Data/FattureClientiContext.cs"
  lang="csharp"
  title="FattureClientiContext.cs"
/>
...
![Solution Explorer Image](./getting-started/solution-explorer.png)
...
![Solution Explorer Image complete](./getting-started/SolutionExplorerImageComplete.png)
...
<RemoteCode 
  url="https://raw.githubusercontent.com/malafronte/malafronte-doc-samples/main/samples-quarta/EFCore/GestioneFattureClienti/GestioneFattureClienti/Program.cs"
  lang="csharp"
  title="Program.cs"
/>
