...
![GestioneFattureClienti struttura DB](./modeling/DB-Structure-GestioneFattureClienti.png)

![GestioneFattureClienti Clienti](./modeling/GestioneFattureClienti-Clienti.png)

![GestioneFattureClienti Fatture](./modeling/GestioneFattureClienti-Fatture.png)
