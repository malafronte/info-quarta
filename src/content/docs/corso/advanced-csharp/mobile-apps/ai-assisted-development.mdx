...
2. **I Commit (I Salvataggi Progressivi)**
...
### 5.3 Provider di Modelli Locali e Cloud (Ollama, KiloCode, OpenCode Zen, OpenRouter, etc. )
...
#### Antigravity e i modelli Gemini
